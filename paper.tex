...
Stakeholders that are affected are for example traditional IT centers, libraries, but also RDM units and legal offices. We argue that an RSE unit does not aim to replace them but 
offers new possibilities to connect these exisiting institutions and thereby enables an academic insititution to offer a stronger portfolio to its scientists.
