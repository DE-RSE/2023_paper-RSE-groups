...
Giving the new RSE department a clear mandate and mission statements delineating it from other departments further mitigates this.
Optimal governance and organisational location are highly individually for each institution.
In order to avoid risks from unclear governance, however, leadership and responsibilities should be clearly communicated from day one.
