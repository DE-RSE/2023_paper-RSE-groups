...
\item A mechanism for selecting and prioritising software projects to be maintained needs to be in place. For on overview of potential selection criteria see the secion \textit{How to decide which software to sustain?} in~\cite{Anzt2021}.
\end{itemize}
