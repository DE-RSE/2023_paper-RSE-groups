...
\abstract{%
This position paper urges decision makers in Germany to establish central RSE units within their institutions in Germany.
Focus is not put primarily on the establishment of RSE services in general, as this has been done already elsewhere.
Instead, motivations for especially central RSE units are discussed, underpined by working examples both in neighboring fields as well as outside of Germany.
...
While it is here that this paper focuses mostly on the German academic environment, some general strategies should also apply elsewhere.
}
