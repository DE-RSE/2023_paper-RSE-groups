...
In this manuscript, we have often compared RSEs to the more established RDM community.
But more broadly speaking these are all instances of \href{https://drtp-skills.ac.uk/}{dRTPs}, so-called digital Research Technical Professionals.
This community will become even more diverse, since also data scientists, ML/AI engineers, or
open science programme offices fall under this umbrella term and can provide useful skills for an RSE unit.
At the same time, dRTPs increasingly fulfil an important mediating role between domain scientists,
institutional infrastructure providers, and national initiatives such as the NFDI.
Beyond providing technical solutions, they translate evolving requirements between communities with different practices, expectations, and technical backgrounds.
