...
Federal state RDM initiatives\footnote{e.g. HeFDI, SaxFDM, FDM-BBB, FDM-NDS and others} accelerate the topic further providing regional training, networking and other supporting services. 
...
Another parallel to RDM initiatives on federal state level (for a list, see~\footnote{\url{https://forschungsdaten.info/fdm-im-deutschsprachigen-raum/deutschland/}}) are currently emerging ideas and grant proposals to establish similar structures at the same level for research software.
