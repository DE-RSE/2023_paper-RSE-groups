...
Beyond development and maintenance, regular training events and workshops equip scientists with the expertise needed to work effectively within the natESM system. A GitLab service, community newsletters, a Mattermost channel for direct exchange, and a dedicated website ensure transparency and engagement across the national Earth system modeling community.
Through this integrated approach, natESM reinforces the technical backbone of Earth system and climate modeling, ensuring that it remains adaptable, scalable, and future-proof.
\end{mdframed}
