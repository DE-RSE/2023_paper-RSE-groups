...
After starting with initial measures not necessarily requiring dedicated funding, we discuss the conceptualisation phase, followed by the RSE unit's foundation, and conclude with measures for promoting its growth.
...
In order to facillitate long term growth of the RSE unit, an institutional policy for requesting person-months in externally funded projects dedicated to RSE should be established.
...
These central positions will be complemented by the existing RSEs organised in the network to form a pool of RSEs associated with the central unit \todo{magi: do you think that's feasible drawing embedded RSEs into a central unit like that. I would assume their PIs have different ideas.}.
