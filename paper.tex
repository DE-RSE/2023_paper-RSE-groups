...
Both RSE and RDM units provide research-oriented services that are supporting digital research\todo{magi: isn't that due to the fact that research software produces (and to a lesser extend relevant here) consumes data}.
