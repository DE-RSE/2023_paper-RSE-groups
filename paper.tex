...
This is partly because the scientific problems being tackled using software
are getting bigger.
However, the software is also expected to be reliable, secure and easy to use.
Handling this increased complexity whilst ensuring timely delivery requires
dedicated RSEs in central RSE units.
...
However, an embedded RSE can feel very lonely when they do not have anybody to
discuss technical problems.
A central RSE unit also provides a social space for RSEs where this exchange
can easily happen.
