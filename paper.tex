...
and different RSE units will focus on different sets of modules.
Thus, it is likely that no two RSE units will be, or need to be, alike.
However, these nine modules, along with their assigned weights (indicating relative importance), form a simple model of an RSE group. This provides both a quick overview of an individual group as well as a way to compare groups.
...
An RSE hub with a long term core staff can partially address this problem by taking over maintenance tasks.
...
A crucial---and sometimes difficult---question is how to position the RSE unit within the institution’s organizational structure.
