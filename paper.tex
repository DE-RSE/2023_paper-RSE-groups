...
\item A mechanism for selecting and prioritising software projects to be maintained needs to be in place. Potential criteria for selection could e.g. be the internal leverage of the project to allow capacity building through research software or the strategic contribution to large community projects.
\end{itemize}
